...
func Title(format string, v ...interface{}) func(*Problem) {
	return func(p *Problem) {
		p.Title = fmt.Sprintf(format, v...)
	}
}

func Detail(format string, v ...interface{}) func(*Problem) {
	return func(p *Problem) {
		p.Detail = fmt.Sprintf(format, v...)
	}
}
